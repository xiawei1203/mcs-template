...
.org-user-row__avatar.tone-0 { background: #5b8ff9; }
.org-user-row__avatar.tone-1 { background: #61ddaa; }
.org-user-row__avatar.tone-2 { background: #f6bd16; }
.org-user-row__avatar.tone-3 { background: #e8684a; }
.org-user-row__info {
  min-width: 0;
  display: flex;
  flex-direction: column;
